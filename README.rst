...
replace all instances of ``frontend-app-survey`` with the name of
...
This section concerns development of ``frontend-app-survey`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-survey/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-survey/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-survey
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-survey.svg
    :target: https://github.com/openedx/frontend-app-survey/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-survey/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-survey/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-survey/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-survey?branch=main
    :alt: Codecov
